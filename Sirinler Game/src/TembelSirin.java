...
public class TembelSirin extends Karakter{
    ...
    public TembelSirin(int oyuncuID, String oyuncuAdi, boolean oyuncuTur, int ID, String Ad, String Tur,int lokasyon,int skor) {
        super(ID, Ad, Tur);
